                                ...
                                <?php $i++; ?>
                                    <?php endforeach; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="right" style="text-align:right"><strong>
                                                $<?php echo $this->cart->format_number($this->cart->total()+ $this->config->item('shipping') + $this->config->item('tax')); ?></strong></td>
                                        </tr>
        </table>
        <br>

        <!--        get rid of shipping info if you're not logged in-->
